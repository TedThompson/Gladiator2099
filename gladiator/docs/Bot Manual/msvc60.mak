...
CLEAN :
	-@erase "$(INTDIR)\a_cmds.obj"
	-@erase "$(INTDIR)\a_game.obj"
	-@erase "$(INTDIR)\a_items.obj"
	-@erase "$(INTDIR)\a_radio.obj"
	-@erase "$(INTDIR)\a_team.obj"
...
!IF "$(CFG)" == "game - Win32 Release" || "$(CFG)" == "game - Win32 Debug"
SOURCE=E:\QuakeDLL\Q2bot\a_cmds.c

"$(INTDIR)\a_cmds.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=E:\QuakeDLL\Q2bot\a_game.c

"$(INTDIR)\a_game.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=E:\QuakeDLL\Q2bot\a_items.c

"$(INTDIR)\a_items.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=E:\QuakeDLL\Q2bot\a_radio.c

"$(INTDIR)\a_radio.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)


SOURCE=E:\QuakeDLL\Q2bot\a_team.c

"$(INTDIR)\a_team.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
