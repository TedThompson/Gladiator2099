...
spawn_t	spawns[] = {
	...
	{"trigger_monsterjump", SP_info_null},						//Removed

#ifdef TRIGGER_COUNTING // Debug tool?
	{"trigger_counting", SP_trigger_counting},
#endif
#ifdef TRIGGER_LOG // Debug tool?
...
// *** Target_
	...
	{"target_secret", SP_info_null},								//Removed
	{"target_goal", SP_info_null},									//Removed
	...
	{"target_help", SP_info_null},									//Removed
	{"target_actor", SP_info_null},									//Removed
	{"target_lightramp", SP_info_null},								//Removed
...
// *** Lights and Points
	...
	{"point_combat", SP_info_null},									//Removed
// *** Misc_ 
	{"misc_explobox", SP_info_null},								//Removed
	{"misc_banner", SP_misc_banner},
	{"misc_satellite_dish", SP_misc_satellite_dish},
	{"misc_actor", SP_info_null},									//Removed
...
// *** Monster_ (removed)
	{"monster_berserk", SP_info_null},								//Removed from here down
		...
		{	// found it
			...
			case F_LSTRING:
				*(char**)(b + f->ofs) = ED_NewString(value);
				break;
			case F_VECTOR:
				v = sscanf(value, "%f %f %f", &vec[0], &vec[1], &vec[2]);
...
void SpawnEntities(char* mapname, char* entities, char* spawnpoint)
{
...
#ifdef BOT
	//clear the model and sound index
	ClearIndexes();
#endif //BOT
	...
	//libraries will be loaded when bots are spawned
	BotSpawn();
